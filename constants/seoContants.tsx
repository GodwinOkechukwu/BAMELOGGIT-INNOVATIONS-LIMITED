...
export const SEODATA: Record<string, SEOConfig> = {
	...
	home: {
		...
		description:
			"Innovate and grow with Bameloggit . We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
		keywords: [
