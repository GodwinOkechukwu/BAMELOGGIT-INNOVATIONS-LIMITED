  ...
  return (
    <>
      <header className="flex flex-col w-full bg-[#fff] z-[100] fixed top-0 border-b border-white/5 shadow-2xl transition-all">
        ...
        <div className="slg:hidden flex flex-col w-full p-4 gap-3 bg-white">
          ...
          <div className="relative h-10">
            <input
              ...
              className="w-full h-full text-sm bg-gray-100 rounded-lg px-4 border-none outline-none focus:ring-2 focus:ring-gray-100"
              value={searchValue}
              onChange={(e) => setSearchValue(e.target.value)}
              onKeyDown={(e) => e.key === "Enter" && handleSearch()}
            />
